    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 审核问题申诉
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
                ...
                <el-table-column label="审核操作" width="160" align="center">
                    <template slot-scope="scope">
                        <div class="checkAction">
                            ...
                            >通过申诉</el-button>
                            <disappeal-ques :q_id="scope.row.qa_id" v-on:getData='getData'></disappeal-ques>
                        </div>
                    </template>
                </el-table-column>
            </el-table>
...
import disappealQues from './module/disappealQues.vue'
export default {
    name: 'basetable',
    components:{
        disappealQues
    ...
    methods: {
        ...
        getData() {
            ...
            this.$axios({
                method: "post",
                url: 'administrator/getappealquestion',
        ...
        handleAgree(index, row) {
            this.$confirm('确定解除屏蔽问题？', '提示', {
                ...
                .then(() => {
                    ...
                    this.$axios({
                        method: "post",
                        url: 'administrator/agreeappealquestion',
                        data: this.$Qs.stringify(data)
                    })
                    .then(function(res) {
