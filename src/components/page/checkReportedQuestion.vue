    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 审核被举报的问题
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
                ...
                <el-table-column label="审核操作" width="160" align="center">
                    <template slot-scope="scope">
                        <div class="checkAction">
                            ...
                            >屏蔽</el-button>
                            <disreport-ques :q_id="scope.row.qr_id" v-on:getData='getData'></disreport-ques>
                        </div>
                    </template>
                </el-table-column>
            </el-table>
...
import disreportQues from './module/disreportQues.vue'
export default {
    name: 'basetable',
    components:{
        disreportQues
    ...
    methods: {
        ...
        getData() {
            ...
            this.$axios({
                method: "post",
                url: 'administrator/getreportquestion',
        ...
        handleAgree(index, row) {
            this.$confirm('确定屏蔽问题？', '提示', {
                ...
                .then(() => {
                    ...
                    this.$axios({
                        method: "post",
                        url: 'administrator/agreereportquestion',
                        data: this.$Qs.stringify(data)
                    })
                    .then(function(res) {
